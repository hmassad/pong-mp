...
class GameWindow(BaseWindow):
    def __init__(self, application):
        ...
        pyglet.clock.schedule_interval(self.server_update, 1 / 20.)
        self.fps_label = pyglet.text.Label(text='FPS: 0', x=0, y=0, anchor_x='left', anchor_y='bottom', batch=self.batch)
        self.key_label = pyglet.text.Label(text='KEY: 0', x=0, y=20, anchor_x='left', anchor_y='bottom', batch=self.batch)
